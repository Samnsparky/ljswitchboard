...
--Sensibus (SBUS) is a proprietary communication protocol used by the SHT11
--The T7 has a special feature that handles sensibus comm, so the script is easy.
...
--WIRES
--Red Wire (Power) DAC1 set to 3.3V
--Black Wire (GND) GND
...
MB.W(1002, 3, 3.3)				--DAC1, provide 3.3V to power the sensor
